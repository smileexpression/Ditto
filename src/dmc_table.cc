...
static uint64_t string_key_hash_computation(const void* data,
                                            uint64_t length,
                                            uint64_t seed,
                                            uint32_t align) {
...
uint64_t DefaultHash::hash_func1(const void* data, uint64_t length) {
  return VariableLengthHash(data, length, 0);
}

uint64_t DefaultHash::hash_func2(const void* data, uint64_t length) {
  return VariableLengthHash(data, length, 0);
}